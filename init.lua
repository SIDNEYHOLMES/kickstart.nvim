...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- ── Dynamic LSP Setup ────────────────────────────────────────────
      -- Any LSP you install via :Mason is automatically configured.
      -- Only servers that need non-default settings have a config file
      -- in lua/custom/lsp/. See lua/custom/lsp/init.lua for details.
      require('custom.lsp')
    end,
  },
